  ...
  <div class="login">
    ...
    <div class="login-main">
      ...
      <div class="login-main-right">
        <div class="login-main-form" v-loading="loading" element-loading-text="登录中" element-loading-background="rgba(241, 245, 248, 0.5)">
          <div class="form-top">
          ...
          <div class="form-center">
            <el-form :model="ruleForm" ref="ruleForm" label-width="0px" class="demo-ruleForm" @submit.native.prevent>
              <el-form-item label="" prop="phone" :rules="rules.phone" style="margin: 50px 0!important;">
              ...
              <el-form-item label="" prop="imgIdentify" id="identifyCode" :rules="rules.imgIdentify" style="margin-bottom: 50px!important;">
              ...
              <el-form-item label="" prop="phoneIdentify" :rules="rules.phoneIdentify" style="margin-bottom: 50px!important;">
      ...
      submitForm(formName) {
        ...
        _self.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            setTimeout(function () {
              if(_self.ruleForm.phone == '18000000000'){//管理员

                let loginObj = {
                  phone:_self.ruleForm.phone,
                  phoneIdentify:_self.ruleForm.phoneIdentify
                };
                localStorage.setItem('adminObj',JSON.stringify(loginObj));
                _self.$router.push({
                  name: 'appAdmin'
                });
              }else if(_self.ruleForm.phone != '18000000000'){//游客
                let userArr = localStorage.getItem('usersData')?JSON.parse(localStorage.getItem('usersData')):[];
                let isPush = true;
                for(let i in userArr){
                  if(_self.ruleForm.phone  == userArr[i].phone){
                    isPush = false;
                  }
                };
                if(isPush){
                  userArr.push({
                    id:userArr.length>0?(parseInt(userArr[userArr.length-1].id)+1):1,
                    phone:_self.ruleForm.phone
                  });
