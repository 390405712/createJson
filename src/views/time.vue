<template>
  <div id="time" style="width: calc(100% - 40px);margin: 0 auto;">
    <el-row :gutter="20">
      <el-col :span="12">
    ...
    <el-row :gutter="20">
      <el-col :span="12">
        <el-card class="box-card">
          <echarts :type="'line'" :chartsName = "chartsName" :chartsData="chartsData" :name="cloName.time"></echarts>
        </el-card>
      </el-col>
      <el-col :span="12">
        <el-card class="box-card">
          <echarts :type="'bar'" :chartsName = "chartsName" :chartsData="chartsData" :name="cloName.time"></echarts>
        </el-card>
      </el-col>
    </el-row>
  </div>
